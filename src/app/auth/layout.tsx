  ...
  children: React.ReactNode;
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen items-center justify-center">
            ...
            <div className="absolute z-0 top-10 right-10 w-[20vw] h-[10vh] z-0 pointer-events-none overflow-hidden z-2">
                <h1
                    className="text-xl md:text-4xl font-bold text-white relative text-right animate-glow"
                    style={{
